...
(Please note that we need to anonymize some of the raw images before release the dataset to a site that has DOI i.e. Zenodo, thus the current location at this shared drive is a temporary solution. We will make sure this is done before the actual conference date.)
